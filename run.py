...
zxcv("inputs/day_21.txt", 2)
print("part 1:", zxcv("inputs/day_21.txt", 64))

# polynomial extrapolation
a0 = zxcv("inputs/day_21.txt.txt", 65)
a1 = zxcv("inputs/day_21.txt.txt", 65 + 131)
a2 = zxcv("inputs/day_21.txt.txt", 65 + 2 * 131)
